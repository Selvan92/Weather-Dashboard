...
// show todays weather    
        ...
        windlable.text("Wind:");
        var windel = $('<p>');
        windel.text(finalResult.current.wind_speed);
  ...
  //append all the elements currentday     
        currentDay.append(cityel,templable,tempel,humiditylable,humidityel,windlable,windel,uvindexlable,uvindexel);
...
//day01
      ...
      var day1tempel = $('<p>');
      day1tempel.text(finalResult.daily[0].feels_like.day);
      ...
      var day1windel = $('<p>');
      day1windel.text(finalResult.daily[0].wind_speed);  
...
var day2tempel = $('<p>');
day2tempel.text(finalResult.daily[1].feels_like.day);
...
var day2windel = $('<p>');
day2windel.text(finalResult.daily[1].wind_speed);  
...
var day3tempel = $('<p>');
day3tempel.text(finalResult.daily[2].feels_like.day);
...
var day3windel = $('<p>');
day3windel.text(finalResult.daily[2].wind_speed);  
...
var day4tempel = $('<p>');
day4tempel.text(finalResult.daily[3].feels_like.day);
...
var day4windel = $('<p>');
day4windel.text(finalResult.daily[3].wind_speed);  
...
var day5tempel = $('<p>');
day5tempel.text(finalResult.daily[4].feels_like.day);
...
var day5windel = $('<p>');
day5windel.text(finalResult.daily[4].wind_speed);  
